...
function TextInput({ value: originalValue, placeholder = "", focus = true, mask, highlightPastedText = false, showCursor = true, onChange, onSubmit }) {
  ...
  if (showCursor && focus) {
    ...
    for (const char of value) {
      renderedValue += i2 >= cursorOffset - cursorActualWidth && i2 <= cursorOffset ? chalk.inverse(char) : char;
      i2++;
    }
...
var historyFileName = "history-cache.json";
function getHistoryFilePath() {
  const historyPath = path.resolve(process.cwd(), historyFileName);
  return historyPath;
}
function ensureHistoryFileExists(filePath) {
...
${formatted}`);
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", padding: 1, children: [
    ...
    thinking && /* @__PURE__ */ jsx(Box, { marginTop: 1, children: /* @__PURE__ */ jsxs(Text3, { color: "green", children: [
      /* @__PURE__ */ jsx(build_default2, { type: "dots" }),
      " Thinking..."
    ] }) })
  ] });
};
