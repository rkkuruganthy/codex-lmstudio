...
// components/codex-app.tsx
import React4 from "react";

// components/codex-chat.tsx
import React3, { useState as useState3, useEffect as useEffect3 } from "react";
import { Box, Text as Text3, useApp } from "ink";
...
var CodexChat = ({ initialPrompt, model, predefinedPrompts }) => {
  ...
  const [showPromptSuggestions, setShowPromptSuggestions] = useState3(false);
  ...
  const handleSubmit = async () => {
    ...
    if (input.trim() === "/help") {
      setResponse("Available Commands: /help, /clear, /summarize, /fix-errors, /review-code");
      setInput("");
      return;
    }
    ...
    try {
      ...
      setThinking(false);
      console.error("\u{1F6A8} Error:", err);
    }
  };
  const filteredPrompts = predefinedPrompts.filter(
    (cmd) => cmd.toLowerCase().startsWith(input.toLowerCase())
  );
  return /* @__PURE__ */ React3.createElement(Box, { flexDirection: "column", padding: 1, width: "100%" }, /* @__PURE__ */ React3.createElement(Box, { marginBottom: 1, flexDirection: "column", borderStyle: "round", borderColor: "cyan" }, /* @__PURE__ */ React3.createElement(Text3, { color: "cyanBright" }, "\u{1F9E0} CodeAssist (Local Codex CLI)"), /* @__PURE__ */ React3.createElement(Text3, null, "Built with \u2764\uFE0F by Ravi using LMStudio & Qwen2.5!")), /* @__PURE__ */ React3.createElement(Box, { marginBottom: 1, flexDirection: "column" }, /* @__PURE__ */ React3.createElement(
    build_default,
    {
      value: input,
      onChange: setInput,
  ...
  ), showPromptSuggestions && filteredPrompts.length > 0 && /* @__PURE__ */ React3.createElement(Box, { flexDirection: "column", paddingLeft: 2, marginTop: 1 }, filteredPrompts.map((cmd, idx) => /* @__PURE__ */ React3.createElement(Text3, { key: idx, color: "yellow" }, "\u2192 ", cmd)))), thinking ? /* @__PURE__ */ React3.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React3.createElement(Text3, { color: "green" }, /* @__PURE__ */ React3.createElement(build_default2, { type: "dots" }), " Thinking...")) : response && /* @__PURE__ */ React3.createElement(Box, { marginBottom: 1, flexDirection: "column" }, /* @__PURE__ */ React3.createElement(Text3, { color: "magentaBright" }, "\u{1F9E0} Assistant Response:"), /* @__PURE__ */ React3.createElement(Text3, null, response), tokensUsed !== null && /* @__PURE__ */ React3.createElement(Text3, { color: "cyan" }, "Tokens Used: ", tokensUsed, " | Time Taken: ", timeTaken, "s")), /* @__PURE__ */ React3.createElement(Box, { marginTop: 1 }, /* @__PURE__ */ React3.createElement(Text3, null, "send ", /* @__PURE__ */ React3.createElement(Text3, { color: "red" }, "q"), " or ", /* @__PURE__ */ React3.createElement(Text3, { color: "red" }, "ctrl+c"), " to exit | send ", /* @__PURE__ */ React3.createElement(Text3, { color: "blue" }, "/clear"), " to reset | send ", /* @__PURE__ */ React3.createElement(Text3, { color: "blue" }, "/help"), " for commands | press ", /* @__PURE__ */ React3.createElement(Text3, { color: "green" }, "enter"), " to send |", /* @__PURE__ */ React3.createElement(Text3, { color: "cyan" }, " shift+enter"), " for new line")));
};
...
try {
  ...
  console.error("\u26A0\uFE0F Warning: Could not load codex-config.json. Using defaults.");
}
var program2 = new Command();
program2.name(config.shortcut_command || "CodeAssist").description("Codex LMStudio CLI").option("-m, --model <model>", "Model to use", config.default_model || "qwen2.5-coder-14b-instruct").parse(process.argv);
...
render(
  /* @__PURE__ */ React6.createElement(Box3, { flexDirection: "column" }, /* @__PURE__ */ React6.createElement(Banner, null), /* @__PURE__ */ React6.createElement(
    CodexApp,
    {
      ...
      model: options.model,
      predefinedPrompts: config.predefined_prompts || []
    }
  ))
);
